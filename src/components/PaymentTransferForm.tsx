...
const createTransfer = async (transferParams: {
  sourceFundingSourceUrl: string;
  destinationFundingSourceUrl: string;
  amount: string;
}) => {
  console.log('Creating transfer:', transferParams);
  // Simulate API call
...
const getBank = async ({ documentId }: { documentId: string }) => {
  ...
  // Simulate API call
  return {
    fundingSourceUrl: 'https://api-sandbox.dwolla.com/funding-sources/sample',
    userId: { $id: 'user123' },
    $id: 'bank123'
  };
};
...
const getBankByAccountId = async ({ accountId }: { accountId: string }) => {
  console.log('Getting bank by account ID:', accountId);
  // Simulate API call
  return {
    fundingSourceUrl: 'https://api-sandbox.dwolla.com/funding-sources/sample',
    userId: { $id: 'user456' },
